...
export default function ArticleExpandOverlay({
  ...
  /**
   * Android Modal coordinate correction.
   * sourceLayout was measured in window space.
   * Modal uses a different origin on Android when
   * statusBarTranslucent is enabled.
   */
